...
public static class ARNativePlugin
{
	...
	public static extern bool arwOpencvTest(int param);

	[DllImport(LIBRARY_NAME, CallingConvention=CallingConvention.Cdecl)]
	[return: MarshalAsAttribute(UnmanagedType.I1)]
	public static extern bool arwSetInteraction(int doInteraction, int platform);

	[DllImport(LIBRARY_NAME, CallingConvention=CallingConvention.Cdecl)]
	[return: MarshalAsAttribute(UnmanagedType.I1)]
	public static extern bool arwSetInteraction2(int doInteraction, int innerSize);


	[DllImport(LIBRARY_NAME, CallingConvention=CallingConvention.Cdecl)]
	[return: MarshalAsAttribute(UnmanagedType.I1)]  // IntPtr rather than int*
	public static extern bool arwGetLastTrig(out float stamp);
	
	[DllImport(LIBRARY_NAME, CallingConvention=CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
	public static extern bool arwSetSavePath(string cfg, int len);

	[DllImport(LIBRARY_NAME, CallingConvention=CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
	public static extern bool arwSetSavePath2(string cfg);

	[DllImport(LIBRARY_NAME, CallingConvention=CallingConvention.Cdecl)]
	[return: MarshalAsAttribute(UnmanagedType.I1)]
	public static extern bool arwGetWarpImagePath([MarshalAs(UnmanagedType.LPStr)]StringBuilder buffer, int stamp, int markerID);

	[DllImport(LIBRARY_NAME, CallingConvention=CallingConvention.Cdecl)]
	[return: MarshalAsAttribute(UnmanagedType.I1)]  // IntPtr rather than int*
	public static extern bool arwSnapWarpImage2Disk(int markerUID, int warpScale, out int stamp);

	[DllImport(LIBRARY_NAME, CallingConvention=CallingConvention.Cdecl)]
	[return: MarshalAsAttribute(UnmanagedType.I1)]
	public static extern bool arwGetLastWarpImagePath([MarshalAs(UnmanagedType.LPStr)]StringBuilder buffer);

	[DllImport(LIBRARY_NAME, CallingConvention=CallingConvention.Cdecl)]
	[return: MarshalAsAttribute(UnmanagedType.I1)]
	public static extern bool arwSnapWarpImage2Texture32(IntPtr colors32, int width, int height, int markerUID);
	
	[DllImport(LIBRARY_NAME, CallingConvention=CallingConvention.Cdecl)]
	[return: MarshalAsAttribute(UnmanagedType.I1)]
	public static extern bool arwGetLastWarpImageTexture32(IntPtr colors32, IntPtr warpImageUID);
